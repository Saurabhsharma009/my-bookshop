...
class BuildTaskHandler {
    ...
    async _copyNativeContent(srcDir, destDir, customFilter) {
    ...
    _commonStagingBuildFilter(src, destDir) {
        ...
        const regex = /gen/
        const targetDir = path.resolve(this.buildOptions.root, this.env.build.target)
        if (src === targetDir) {
            return false
        }
    ...
    static _setProperty(src, segments, value) {
        segments = Array.isArray(segments) ? segments : [segments]
