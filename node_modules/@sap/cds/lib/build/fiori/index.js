...
class FioriAppModuleBuilder extends BuildTaskHandler {
    ...
    async _compileEdmx(src, dest) {
        ...
        const mainService = BuildTaskHandler._getProperty(manifest, ['sap.app', 'dataSources', 'mainService'])
        if (!mainService) {
        ...
        const localUri = BuildTaskHandler._getProperty(mainService, ['settings', 'localUri'])
