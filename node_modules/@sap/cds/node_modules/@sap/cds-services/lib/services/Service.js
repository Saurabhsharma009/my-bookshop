...
const { checkIntegrityWrapper, flattenDeepToOneAssociations } = require('./utils/handlerUtils')
...
class Service extends Client {
  ...
  constructor ({ csn, reflectedModel }, options) {
    ...
    // REVISIT: We should remove that here, to have that managed consistently in umbrella,
    // yet we can't do so now, due to the many local pseudo-integration tests.
  ...
  _getMessagingOptions () {
    ...
    Object.assign(this.options.credentials.messaging, credentials)
