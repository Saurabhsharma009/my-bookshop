...
function getDefinerFunctions( model ) {
  ...
  function createTargetEntity( target, elem, keys, entityName, base ) {
    ...
    addProxyElements( art, keys, 'type-composition', location );
    ...
    addProxyElements( art, target.elements, 'type-composition', location );
  ...
  function addProxyElements( proxyDict, elements, inferred, location ) {
  ...
  function createTextsEntity( base, absolute, textElems ) {
    ...
    addBoolAnnotationTo('@odata.draft.enabled', false, art); // TODO: reokplace
    const locale = {
